...
import { UserServiceBase, NotificationService, UserAuthenticationService, LoggingService, UserAuthenticationQuery, AppSettingsQuery, SpinnerService, ComponentLoaderService } from 'ngscaffolding-core';
